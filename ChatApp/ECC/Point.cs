...
namespace ChatApp.ECC
{
    ...
    public class Point
    {
        ...
        public void CheckPoint() => Curve.CheckPoint(this);
        ...
        public static Point Add(Point first, Point second)
        {
            ...
            Curve commonCurve = new Curve(Curve.CurveName.secp256k1);
            ...
            commonCurve.CheckPoint(first);
            commonCurve.CheckPoint(second);
